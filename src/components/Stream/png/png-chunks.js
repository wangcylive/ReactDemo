import {crc32} from '@/components/Stream/png/crc32'
 ...
 */
export function defineDataViewProperty(object, name, dataView, bits, offset) {
...
export class sRGBChunk extends PNGChunk {
  constructor({data}) {
    ...
    const values = ['perceptual', 'relative colorimetric', 'saturation', 'absolute colorimetric']
    const dv = new DataView(data)
    Object.defineProperty(this, 'value', {
      enumerable: true,
      get() {
